[![GitHub stars](https://img.shields.io/github/stars/scorebar/scorebar?style=social)](https://github.com/scorebar/scorebar/stargazers)
![License](https://img.shields.io/github/license/scorebar/scorebar)
[![Twitter Follow](https://img.shields.io/twitter/follow/SuveenE?style=social)](https://x.com/SuveenE)

# ScoreBar - AI-powered voice interviewer for hiring 💼

ScoreBar is an open source platform for companies to conduct AI powered hiring interviews with their candidates.

<img src="https://github.com/user-attachments/assets/fa92ade1-02ea-4332-b5ed-97056dea01c3" alt="ScoreBar Logo" width="800">
...
```bash
git clone https://github.com/scorebar/scorebar.git
```
...
If you'd like to contribute to ScoreBar, feel free to fork the repository, make your changes, and submit a pull request. Contributions are welcomed and appreciated.

For a detailed guide on contributing, read the [CONTRIBUTING.md](CONTRIBUTING.md) file.

## Show Your Support 🌟

If you find ScoreBar helpful, please consider giving us a star on GitHub! It helps us reach more developers and continue improving the project.

## Products built on top of ScoreBar 🚀
